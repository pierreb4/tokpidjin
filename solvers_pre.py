...
def solve_045e512c(S, I, C):
    ...
    x13 = remove_t(x2, x1)
    x14 = mapply_t(x12, x13)
    O = paint(I, x14)
    return O

def solve_4258a5f9(S, I, C):
    x1 = f_ofcolor(I, FIVE)
    x2 = mapply_t(neighbors, x1)
    O = fill(I, ONE, x2)
    return O
...
def solve_22eb0ac0(S, I, C):
    ...
    x2 = fgpartition(I)
    x3 = apply(x1, x2)
    x4 = mfilter(x3, hline_o)
    O = paint(I, x4)
    return O

def solve_60b61512(S, I, C):
    x1 = o_g_t(I, R7)
    x2 = mapply_t(delta, x1)
    O = fill(I, SEVEN, x2)
    return O
...
def solve_1e32b0e9(S, I, C):
    ...
    x11 = extract(x8, x10)
    x12 = palette(x11)
    x13 = difference_t(x2, x12)
    x14 = get_color_rank_t(I, F0)
    x15 = initset(x14)
    x16 = difference_t(x13, x15)
...
def solve_9aec4887(S, I, C):
    x1 = o_g_t(I, R3)
    x2 = get_arg_rank_t(x1, numcolors_f, L1)
    x3 = other(x1, x2)
    x4 = subgrid(x3, I)
...
def solve_db93a21d(S, I, C):
    ...
    x5 = o_g_t(I, R7)
    x6 = colorfilter_t(x5, NINE)
    x7 = mapply_t(outbox, x6)
    x8 = fill(x4, THREE, x7)
    x9 = power(outbox, TWO)
    ...
    x18 = sfilter(x6, x17)
    x19 = mapply_t(x16, x18)
    O = fill(x15, THREE, x19)
    return O

def solve_264363fd(S, I, C):
    x1 = o_g_t(I, R1)
    x2 = get_arg_rank_t(x1, size, L1)
    x3 = cover(I, x2)
    x4 = rbind(subgrid, x3)
    x5 = height(x2)
    x6 = equality(x5, FIVE)
...
def solve_1b60fb0c(S, I, C):
    ...
    x3 = lbind(shift, x2)
    x4 = neighbors(ORIGIN)
    x5 = mapply_t(neighbors, x4)
    x6 = apply(x3, x5)
    x7 = f_ofcolor(I, ONE)
    x8 = lbind(intersection, x7)
    x9 = compose(size, x8)
    x10 = get_arg_rank_t(x6, x9, F0)
...
def solve_98cf29f8(S, I, C):
    ...
    x11 = chain(x10, ineighbors, identity)
    x12 = chain(x8, x9, x11)
    x13 = sfilter(x5, x12)
    x14 = outbox(x13)
    x15 = backdrop(x14)
...
def solve_de1cd16c(S, I, C):
    x1 = rbind(subgrid, I)
    x2 = o_g_t(I, R4)
    x3 = sizefilter_t(x2, ONE)
    x4 = difference_t(x2, x3)
    x5 = apply(x1, x4)
    x6 = get_color_rank_t(I, L1)
    x7 = rbind(colorcount_t, x6)
    x8 = get_arg_rank_t(x5, x7, F0)
...
def solve_178fcbfb(S, I, C):
    x1 = f_ofcolor(I, TWO)
    x2 = mapply_t(vfrontier, x1)
    x3 = fill(I, TWO, x2)
    x4 = compose(hfrontier, center)
    x5 = fork(recolor_i, color, x4)
    x6 = o_g_t(I, R5)
    x7 = colorfilter_t(x6, TWO)
    x8 = difference_t(x6, x7)
    x9 = mapply_t(x5, x8)
    O = paint(x3, x9)
    return O
...
def solve_97a05b5b(S, I, C):
    ...
    x52 = sfilter(x1, x51)
    x53 = mapply_t(x49, x52)
    x54 = mapply_t(x37, x53)
    x55 = paint(x3, x54)
    ...
    x64 = sfilter(x52, x63)
    x65 = mapply_t(x49, x64)
    x66 = mapply_t(x57, x65)
    O = paint(x55, x66)
    return O
...
def solve_72322fa7(S, I, C):
    ...
    x13 = sfilter(x11, x12)
    x14 = difference_t(x11, x13)
    x15 = mapply_t(x10, x14)
    x16 = paint(I, x15)
    x17 = lbind(rbind, add)
    x18 = rbind(corner, R0)
...
def solve_681b3aeb(S, I, C):
    x1 = mir_rot_t(I, R6)
    x2 = o_g_t(x1, R5)
    x3 = get_arg_rank_t(x2, size, L1)
    x4 = color(x3)
    x5 = canvas(x4, THREE_BY_THREE)
    x6 = get_arg_rank_t(x2, size, F0)
    x7 = normalize(x6)
    x8 = paint(x5, x7)
    O = mir_rot_t(x8, R4)
    return O
...
def solve_2bcee788(S, I, C):
    ...
    x3 = o_g_t(I, R5)
    x4 = get_arg_rank_t(x3, size, L1)
    x5 = hline_o(x4)
    x6 = get_arg_rank_t(x3, size, F0)
    x7 = subgrid(x6, x2)
    x8 = mir_rot_t(x7, R0)
    x9 = mir_rot_t(x7, R2)
    x10 = branch(x5, x8, x9)
...
def solve_3e980e27(S, I, C):
    ...
    x21 = sfilter(x19, x20)
    x22 = get_arg_rank_t(x21, size, F0)
    x23 = mir_rot(x22, R2)
    x24 = x11(x23)
    x25 = remove_t(x22, x21)
    x26 = mapply_t(x24, x25)
    ...
    x32 = sfilter(x19, x31)
    x33 = get_arg_rank_t(x32, size, F0)
    x34 = x30(x33)
    x35 = remove_t(x33, x32)
    x36 = mapply_t(x34, x35)
    x37 = combine(x26, x36)
    O = paint(I, x37)
    return O
...
def solve_e40b9e2f(S, I, C):
    ...
    x7 = lbind(shift, x6)
    x8 = neighbors(ORIGIN)
    x9 = mapply_t(neighbors, x8)
    x10 = apply(x7, x9)
    x11 = lbind(intersection, x5)
    x12 = get_arg_rank_t(x10, x11, F0)
    x13 = paint(I, x12)
...
def solve_25d8a9c8(S, I, C):
    x1 = o_g_t(I, R4)
    x2 = sizefilter_t(x1, THREE)
    x3 = mfilter(x2, hline_o)
    x4 = toindices(x3)
    x5 = fill(I, FIVE, x4)
    x6 = asindices(I)
    x7 = difference_t(x6, x4)
    O = fill(x5, ZERO, x7)
    return O
...
def solve_93b581b8(S, I, C):
    ...
    x11 = toindices(x5)
    x12 = mapply_t(x10, x11)
    x13 = difference_t(x12, x11)
    O = fill(x9, ZERO, x13)
    return O
...
def solve_b2862040(S, I, C):
    x1 = o_g_t(I, R4)
    x2 = colorfilter_t(x1, ONE)
    x3 = colorfilter_t(x1, NINE)
...
def solve_a61f2674(S, I, C):
    x1 = replace(I, FIVE, ZERO)
    x2 = o_g_t(I, R5)
    x3 = get_arg_rank_t(x2, size, F0)
    x4 = recolor_o(ONE, x3)
    x5 = get_arg_rank_t(x2, size, L1)
    x6 = recolor_o(TWO, x5)
    x7 = combine(x4, x6)
    O = paint(x1, x7)
    return O
...
def solve_9d9215db(S, I, C):
    ...
    x11 = get_arg_rank_t(x9, x10, F0)
    x12 = mir_rot_t(x11, R2)
    x13 = papply(pair, x11, x12)
    x14 = apply(x2, x13)
    x15 = rbind(corner, R2)
    x16 = partition(x14)
    x17 = sizefilter_t(x16, FOUR)
    x18 = apply(x15, x17)
    x19 = rbind(corner, R3)
    x20 = apply(x19, x17)
    x21 = combine(x18, x20)
...
def solve_57aa92db(S, I, C):
    ...
    x14 = get_arg_rank_t(x6, x13, F0)
    x15 = normalize_o(x14)
    x16 = lbind(shift, x15)
    x17 = rbind(corner, R0)
    x18 = get_color_rank(x14, L1)
    x19 = matcher(x1, x18)
    x20 = sfilter(x15, x19)
    x21 = corner(x20, R0)
    ...
    x28 = o_g_t(I, R5)
    x29 = colorfilter_t(x28, x18)
    x30 = mapply_t(x27, x29)
    x31 = paint(I, x30)
    x32 = merge_t(x28)
    O = paint(x31, x32)
    return O
...
def solve_36d67576(S, I, C):
    ...
    x28 = combine(x22, x27)
    x29 = o_g_t(I, R1)
    x30 = get_arg_rank_t(x29, numcolors_f, F0)
    x31 = rapply_t(x28, x30)
    x32 = mapply_t(x15, x31)
    O = paint(I, x32)
    return O
...
def solve_b775ac94(S, I, C):
    ...
    x34 = o_g_t(I, R3)
    x35 = mapply_t(x33, x34)
    x36 = paint(I, x35)
    x37 = rbind(mir_rot_f, R2)
    x38 = rbind(get_nth_f, L1)
    # x38 = rbind(get_nth_f, F0)
    x39 = chain(tojvec, x38, x21)
    # x39 = chain(tojvec, identity, x21)
...
def solve_f8c80d96(S, I, C):
    x1 = get_color_rank_t(I, L1)
    x2 = o_g_t(I, R4)
    x3 = get_arg_rank_t(x2, width_f, L1)
    x4 = size(x3)
    x5 = equality(x4, ONE)
    x6 = branch(x5, identity, outbox)
    x7 = chain(outbox, outbox, x6)
    x8 = colorfilter_t(x2, x1)
    x9 = get_arg_rank_t(x8, size, F0)
    x10 = x7(x9)
    x11 = fill(I, x1, x10)
    x12 = power(x7, TWO)
...
def solve_7837ac64(S, I, C):
    ...
    x3 = lbind(apply, x2)
    x4 = fgpartition(I)
    x5 = get_arg_rank_t(x4, size, F0)
    x6 = remove_t(x5, x4)
    x7 = merge_t(x6)
    x8 = subgrid(x7, I)
    x9 = height_t(x8)
    x10 = o_g_t(x8, R4)
    x11 = colorfilter_t(x10, ZERO)
    x12 = get_nth_t(x11, F0)
    x13 = height(x12)
    x14 = increment(x13)
...
def solve_6e19193c(S, I, C):
    ...
    x12 = o_g_t(I, R5)
    x13 = mapply_t(x11, x12)
    x14 = fill(I, x1, x13)
    x15 = mapply_t(delta, x12)
    O = fill(x14, ZERO, x15)
    return O
...
def solve_ddf7fa4f(S, I, C):
    ...
    x5 = o_g_t(I, R5)
    x6 = sizefilter_t(x5, ONE)
    x7 = colorfilter_t(x5, FIVE)
    x8 = product(x6, x7)
...
def solve_868de0fa(S, I, C):
    x1 = o_g_t(I, R4)
    x2 = sfilter(x1, square_f)
    x3 = compose(even, height_f)
    x4 = sfilter(x2, x3)
    x5 = merge_t(x4)
    x6 = fill(I, TWO, x5)
    x7 = difference_t(x2, x4)
    x8 = merge_t(x7)
    O = fill(x6, SEVEN, x8)
    return O
...
def solve_272f95fa(S, I, C):
    ...
    x12 = get_arg_rank_t(x10, x11, L1)
    x13 = fill(x7, TWO, x12)
    x14 = get_arg_rank_t(x10, x11, F0)
    x15 = fill(x13, ONE, x14)
    x16 = lbind(hmatching, x6)
    x17 = sfilter(x8, x16)
    x18 = rbind(col_row, R2)
    x19 = get_arg_rank_t(x17, x18, L1)
    x20 = fill(x15, FOUR, x19)
    x21 = get_arg_rank_t(x17, x18, F0)
...
def solve_447fd412(S, I, C):
    ...
    x22 = apply(x20, x21)
    x23 = o_g_t(I, R3)
    x24 = get_arg_rank_t(x23, numcolors_f, F0)
    x25 = normalize(x24)
    x26 = rapply_t(x22, x25)
    x27 = mapply_t(x19, x26)
    O = paint(I, x27)
    return O
...
def solve_06df4c85(S, I, C):
    ...
    x7 = partition(I)
    x8 = get_arg_rank_t(x7, size, F0)
    x9 = colorfilter_t(x7, ZERO)
    x10 = difference_t(x7, x9)
    x11 = remove_t(x8, x10)
    x12 = merge_t(x11)
    x13 = product(x12, x12)
    x14 = compose(last_t, x2)
    x15 = compose(last_t, x1)
...
def solve_f1cefba8(S, I, C):
    ...
    x23 = sfilter(x15, x22)
    x24 = mapply_t(vfrontier, x23)
    x25 = difference_t(x15, x23)
    x26 = mapply_t(hfrontier, x25)
    x27 = combine(x24, x26)
    x28 = fill(I, x12, x27)
...
def solve_c0f76784(S, I, C):
    x1 = o_g_t(I, R4)
    x2 = colorfilter_t(x1, ZERO)
    x3 = sfilter(x2, square_f)
    x4 = merge_t(x3)
    x5 = fill(I, SEVEN, x4)
    x6 = get_arg_rank_t(x3, size, F0)
    x7 = fill(x5, EIGHT, x6)
    x8 = sizefilter_t(x3, ONE)
    x9 = merge_t(x8)
    O = fill(x7, SIX, x9)
    return O
...
def solve_b60334d2(S, I, C):
    x1 = replace(I, FIVE, ZERO)
    x2 = f_ofcolor(I, FIVE)
    x3 = mapply_t(dneighbors, x2)
    x4 = fill(x1, ONE, x3)
    x5 = mapply_t(ineighbors, x2)
    O = fill(x4, FIVE, x5)
    return O
...
def solve_694f12f3(S, I, C):
    x1 = compose(backdrop, inbox)
    x2 = o_g_t(I, R4)
    x3 = colorfilter_t(x2, FOUR)
    x4 = get_arg_rank_t(x3, size, L1)
    x5 = x1(x4)
    x6 = fill(I, ONE, x5)
    x7 = get_arg_rank_t(x3, size, F0)
    x8 = x1(x7)
    O = fill(x6, TWO, x8)
    return O
...
def solve_4612dd53(S, I, C):
    ...
    x4 = subgrid(x1, x3)
    x5 = f_ofcolor(x4, ONE)
    x6 = mapply_t(vfrontier, x5)
    x7 = size(x6)
    x8 = mapply_t(hfrontier, x5)
    x9 = size(x8)
    x10 = greater(x7, x9)
...
def solve_1c786137(S, I, C):
    x1 = o_g_t(I, R4)
    x2 = get_arg_rank_t(x1, height_f, F0)
    x3 = subgrid(x2, I)
    O = trim(x3)
    return O
...
def solve_5daaa586(S, I, C):
    ...
    x13 = mfilter(x12, vline_i)
    x14 = size(x13)
    x15 = mfilter(x12, hline_i)
    x16 = size(x15)
    x17 = greater(x14, x16)
...
def solve_2dd70a9a(S, I, C):
    ...
    x22 = o_g_t(x21, R4)
    x23 = colorfilter_t(x22, ONE)
    x24 = rbind(adjacent, x1)
    x25 = sfilter(x23, x24)
    x26 = difference_t(x23, x25)
    x27 = merge_t(x26)
    x28 = cover(x21, x27)
...
def solve_673ef223(S, I, C):
    ...
    x15 = colorfilter_t(x2, TWO)
    x16 = apply(x3, x15)
    x17 = x14(x16)
    x18 = toivec(x17)
    x19 = shift(x9, x18)
    x20 = mapply_t(hfrontier, x19)
...
def solve_d6ad076f(S, I, C):
    x1 = o_g_t(I, R5)
    x2 = get_arg_rank_t(x1, size, L1)
    x3 = get_arg_rank_t(x1, size, F0)
    x4 = vmatching(x2, x3)
    x5 = branch(x4, DOWN, RIGHT)
    x6 = rbind(col_row, R1)
    x7 = rbind(col_row, R2)
    x8 = branch(x4, x6, x7)
    x9 = get_val_rank(x1, x8, F0)
    x10 = x8(x2)
    x11 = equality(x9, x10)
...
def solve_d9f24cd1(S, I, C):
    ...
    x13 = mapply_t(x6, x12)
    x14 = fill(x5, TWO, x13)
    x15 = difference_t(x8, x10)
    x16 = colorfilter_t(x15, TWO)
    x17 = mapply_t(toindices, x16)
    x18 = mapply_t(vfrontier, x17)
    O = fill(x14, TWO, x18)
    return O
...
def solve_50846271(S, I, C):
    ...
    x8 = fill(I, TWO, x7)
    x9 = o_g_t(x8, R4)
    x10 = colorfilter_t(x9, TWO)
    x11 = get_val_rank(x10, width_f, F0)
    x12 = halve(x11)
    x13 = toivec(x12)
    x14 = rbind(add, x13)
...
def solve_6aa20dc0(S, I, C):
    ...
    x26 = apply(x12, x25)
    x27 = o_g_t(I, R3)
    x28 = get_arg_rank_t(x27, numcolors_f, F0)
    x29 = normalize(x28)
    x30 = rapply(x26, x29)
    x31 = mapply_t(x10, x30)
    O = paint(I, x31)
    return O
...
def solve_234bbc79(S, I, C):
    ...
    x30 = fork(astuple, x29, x28)
    x31 = o_g_t(I, R1)
    x32 = size(x31)
    x33 = power(x30, x32)
    # x34 = astuple(ZERO, DOWN_LEFT)
    x34 = ascell(DOWN_LEFT, ZERO)
    x35 = initset(x34)
    ...
    x41 = ascell(x40, x35)
    x42 = x33(x41)
    x43 = get_nth_t(x42, F0)
    x44 = width(x43)
    x45 = decrement(x44)
    # x46 = astuple(THREE, x45)
    x46 = ascell(x45, THREE)
    x47 = canvas(ZERO, x46)
    O = paint(x47, x43)
    return O
...
def solve_aba27056(S, I, C):
    x1 = o_g_t(I, R5)
    x2 = mapply_t(toindices, x1)
    x3 = delta(x2)
    x4 = fill(I, FOUR, x3)
    x5 = box(x2)
    x6 = difference_t(x5, x2)
    x7 = lbind(shift, x6)
    x8 = position(x3, x6)
...
def solve_6855a6e4(S, I, C):
    ...
    x6 = branch(x4, I, x5)
    x7 = o_g_t(x6, R5)
    x8 = colorfilter_t(x7, FIVE)
    x9 = merge_t(x8)
    x10 = cover(x6, x9)
    x11 = rbind(get_nth_f, F0)
    x12 = compose(x11, center)
    x13 = apply(center, x8)
    x14 = get_val_rank(x13, x11, L1)
    x15 = matcher(x12, x14)
    x16 = extract(x8, x15)
    x17 = subgrid(x16, x6)
...
def solve_2bee17df(S, I, C):
    ...
    x13 = mapply_t(hfrontier, x12)
    x14 = mir_rot_t(I, R4)
    x15 = x8(x14)
    x16 = pair(x15, x2)
    x17 = rbind(get_nth_f, F0)
    x18 = sfilter_t(x16, x17)
    x19 = mapply_t(vfrontier, x18)
    x20 = astuple(x13, x19)
    x21 = merge_t(x20)
...
def solve_0e206a2e(S, I, C):
    ...
    x37 = sfilter(x34, x36)
    x38 = mapply_t(x33, x37)
    x39 = mapply_t(x19, x38)
    x40 = paint(I, x39)
    x41 = merge_t(x37)
    O = cover(x40, x41)
    return O
...
def solve_4c5c2cf0(S, I, C):
    ...
    x21 = paint(I, x20)
    x22 = o_g_t(x21, R3)
    x23 = get_nth_t(x22, F0)
    x24 = subgrid(x23, x21)
    x25 = mir_rot_t(x24, R2)
    x26 = o_g_t(x25, R3)
    x27 = get_nth_t(x26, F0)
    x28 = o_g_t(x25, R7)
    x29 = color(x12)
...
def solve_d5d6de2d(S, I, C):
    ...
    x3 = o_g_t(I, R5)
    x4 = sfilter(x3, square_f)
    x5 = difference_t(x3, x4)
    x6 = mapply_t(x2, x5)
    O = fill(x1, THREE, x6)
    return O
...
def solve_508bd3b6(S, I, C):
    ...
    x16 = get_arg_rank_t(x1, size, F0)
    x17 = paint(x15, x16)
    x18 = o_g_t(x17, R5)
    x19 = rbind(adjacent, x16)
    x20 = extract(x18, x19)
    x21 = get_nth_t(x20, F0)
...
def solve_3345333e(S, I, C):
    ...
    x13 = get_arg_rank_t(x10, x12, F0)
    O = fill(x3, x4, x13)
    return O

def solve_0ca9ddb6(S, I, C):
    x1 = f_ofcolor(I, ONE)
    x2 = mapply_t(dneighbors, x1)
    x3 = fill(I, SEVEN, x2)
    x4 = f_ofcolor(I, TWO)
    x5 = mapply_t(ineighbors, x4)
    O = fill(x3, FOUR, x5)
...
def solve_99fa7670(S, I, C):
    ...
    x22 = order(x20, x21)
    x23 = remove_t(x18, x22)
    x24 = get_nth_t(x22, F0)
    x25 = remove_t(x24, x22)
    x26 = pair(x23, x25)
    x27 = mapply_t(x14, x26)
    O = underpaint(x6, x27)
    return O
...
def solve_6455b5f5(S, I, C):
    ...
    x3 = recolor_o(ONE, x2)
    x4 = paint(I, x3)
    x5 = colorfilter_t(x1, ZERO)
    x6 = get_val_rank(x1, size, L1)
    x7 = sizefilter_t(x5, x6)
    x8 = merge_t(x7)
    O = fill(x4, EIGHT, x8)
    return O
...
def solve_b527c5c6(S, I, C):
    ...
    x38 = sfilter(x23, x37)
    x39 = difference_t(x23, x38)
    x40 = mapply_t(x36, x39)
    x41 = lbind(apply, tojvec)
    x42 = compose(x41, x34)
    x43 = fork(mapply, x27, x42)
    x44 = mapply_t(x43, x38)
    x45 = combine(x40, x44)
...
def solve_e76a88a6(S, I, C):
    x1 = o_g_t(I, R1)
    x2 = get_arg_rank_t(x1, numcolors_f, F0)
    x3 = normalize(x2)
    x4 = lbind(shift, x3)
    x5 = rbind(corner, R0)
    x6 = remove_t(x2, x1)
...
def solve_ecdecbb3(S, I, C):
    ...
    x8 = o_g_t(I, R5)
    x9 = colorfilter_t(x8, TWO)
    x10 = colorfilter_t(x8, EIGHT)
    x11 = product(x9, x10)
    x12 = apply(x7, x11)
...
def solve_d07ae81c(S, I, C):
    ...
    x5 = neighbors(x4)
    x6 = toobject(x5, I)
    x7 = get_color_rank(x6, F0)
    x8 = difference_t(x1, x2)
    x9 = apply(color, x8)
    x10 = get_nth_t(x9, F0)
    x11 = equality(x7, x10)
    x12 = color(x3)
...
def solve_f35d900a(S, I, C):
    ...
    x7 = mapply_t(x5, x6)
    x8 = paint(I, x7)
    x9 = mapply_t(toindices, x6)
    x10 = box(x9)
    x11 = difference_t(x10, x9)
    x12 = rbind(get_arg_rank, L1)
    x13 = lbind(x12, x9)
